...
import person from "../../photo/peek.jpg";
...
export default function CatHead() {
  ...
  const reset = useCallback(() => {
    ...
    ref.current = [];
    set([]);
    ref.current.push(setTimeout(() => set(["Selection", "Anetiquette"]), 2000));
  ...
  return (
    <div className="categorydecor mb-5" style={{ height: "50vh" }}>
      ...
      <div className="col-6 d-flex flex-row-reverse my-5 p-5 cathead_text_contain">
        ...
        <div className="col-6 my-5 cathead_img">
