...
const AddProduts = () => {
  ...
  const productAdd=(e)=>{
    ...
    axios.post("http://localhost:4000/product/add", data, config)
    .then((response)=>{
        ...
        <div className="container col-5">
          <form>
            ...
            <div class="form-group mt-2 text-secondary">
              ...
              <input type="number" class="form-control" onChange={(e)=>{setPrice(e.target.value)}}></input>
            </div>

            <div class="form-group mt-2 text-secondary">
              <label for="FormControlSelect1">Category</label>
              <select class="form-control" id="FormControlSelect1" onChange={(e)=>{setCategory(e.target.value)}}>
          ...
          <button type="button" class="btn btn-success mt-3" onClick={productAdd}>
            Submit
          </button>
        </div>
      </div>
