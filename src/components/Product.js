...
const Product = () => {
  ...
  const bidding = (e)=>{
    ...
    axios.post("http://localhost:4000/product/single/"+pid+"/bid",money,config)
    .then((response)=>{
  ...
  const bought = (e)=>{
    ...
    axios.put("http://localhost:4000/product/single/"+pid+"/bought",data, config)
    .then((response)=>{
      console.log(response)
    })
    .catch((e)=>{
      ...
      <div className="container-fluid p-2 mt-3">
        <div className="row row-cols-1 row-cols-md-2">
          {type == "auction" ? 
            <div>
              ...
              <div className="col mt-5 p-3">
                ...
                <form>
                  ...
                  ></input>
                  <span>
                    <button type="button" className="bidbtn mx-3" onClick={bidding}>
           ...
           : 
           <button type="button" class="btn btn-dark" onClick={bought}>Purchase</button>
           }
        </div>
      </div>
      <Footer />
