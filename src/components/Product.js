        ...
        <div className="row row-cols-1 row-cols-md-2">
          ...
          <div className="col">
            ...
            <form>
              ...
              ></input>
              <span>
                <button type="button" className="bidbtn mx-3" onClick="">
